...
@ManagedBean(name = "AddNewPcaptNajmaBean")
@SessionScoped
public class AddNewPcaptNajmaBean {
    String cdePcapt,cdePcaptSelected,
           nomPcapt;
    String type="AG";
    String msg="";
    String cdeAge="",secteur="",circuit="",loc;
//           libAge="";
	String lblBq="NAJMAH";
...
//		listages=service.getAllAge();
 ...
 public void AddNewpcaptSgma(){
	 ...
	 cdeAge="05"+cdePcapt.substring(2,cdePcapt.length());	
	 ...
	 if(flag==0 ){
		 ...
		 FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "INFO", msg));
          metier.AddAge(lblBq, new BeanAgence(pcapt.getAgeRattachement(), pcapt.getNomPcapt(), loc, null));
		
		 }
	
	 listpcapts =metier.getAllPcapt(lblBq);
     listpcaptSelecteds=metier.getAllPcapt(lblBq);
     cdePcapt=nomPcapt=circuit=secteur="";
 }
