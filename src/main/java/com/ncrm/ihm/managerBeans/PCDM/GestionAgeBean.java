package com.ncrm.ihm.managerBeans.PCDM;
...
@ManagedBean(name = "Gestion_AgePCDMBean")
@SessionScoped
...
private final String LblBq="PCDM";
...
public void init(){
	...
	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "Nombre d'agences PCDM dans la base de reference  = "+agences.size()));
