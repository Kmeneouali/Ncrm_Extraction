...
@ManagedBean(name = "Etats_LcnSGBean")
@RequestScoped
public class EtatsLcnBean {
	...
	private final String folderREC = Propriete.getInsatance().get("SGMA.OUT.REC");
...
//		 FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "-", msg)); 
 ...
 public void editetatsLCN(){
		...
		System.out.println("dtePree ... "+DateUtils.formatStringToDate(dtepres,"yyyy-MM-dd"));
 ...
 public void editRcWc(){
	 ...
	 if(recordRems.size()>0){
		metier.formatageChamps(recordRems, dteInstance);
		 ...
		 String nameFile=folderREC+"\\022.060."+dteInstance+".rec";
			String header="RECO022060"+dteInstance;
		if(metier.createFileRec(recordRems, nameFile, header, cdeTr).size()>0){
