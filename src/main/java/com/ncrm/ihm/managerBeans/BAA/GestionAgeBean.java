...
@ManagedBean(name = "Gestion_AgeBAABean")
@SessionScoped
...
public void init(){
	...
	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "Nombre d'agences BAA dans la base de reference  = "+agences.size()));
