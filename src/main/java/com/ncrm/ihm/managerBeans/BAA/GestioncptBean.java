...
@ManagedBean(name = "Gestion_cptBAABean")
...
public class GestioncptBean {
	...
	public String GetAllCompt() {
			...
			comptes=metier.getAllComptes(LblBq);
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "Nombre de comptes BAA dans la base de reference = "+comptes.size()));

		
		
		return "BAAGestionCpt";
