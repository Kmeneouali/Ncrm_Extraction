package com.ncrm.ihm.managerBeans.BTI;
...
@ManagedBean(name = "Gestion_AgeBTIBean")
@SessionScoped
...
private final String LblBq="BTI";
...
public void init(){
	...
	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "Nombre d'agences BTI dans la base de reference  = "+agences.size()));
