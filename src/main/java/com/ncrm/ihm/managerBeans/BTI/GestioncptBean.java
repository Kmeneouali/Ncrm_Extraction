...
@ManagedBean(name = "Gestion_cptBTIBean")
...
public class GestioncptBean {
	...
	public String GetAllCompt() {
			...
			comptes=metier.getAllComptes(LblBq);
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "Nombre de comptes BTI dans la base de reference = "+comptes.size()));

		
		
		return "BTIGestionCpt";
