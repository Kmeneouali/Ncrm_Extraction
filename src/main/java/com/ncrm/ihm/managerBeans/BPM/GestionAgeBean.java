package com.ncrm.ihm.managerBeans.BPM;
...
@ManagedBean(name = "Gestion_AgeBPMBean")
@SessionScoped
...
private final String LblBq="BPM";
...
public void init(){
	...
	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "Nombre d'agences Bpm dans la base de reference  = "+agences.size()));
