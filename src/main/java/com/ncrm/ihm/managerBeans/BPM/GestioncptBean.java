...
@ManagedBean(name = "Gestion_cptBPMBean")
...
public class GestioncptBean {
	...
	public String GetAllCompt() {
			...
			comptes=metier.getAllComptes(LblBq);
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Info", "Nombre de comptes Bpm dans la base de reference = "+comptes.size()));

		
		
		return "BpmGestionCpt";
