...
public class DataFilterProcessorEtaChqBpm implements ItemProcessor<BeanEtatsChq, BeanEtatsChq>  {
	
	
	private static final Logger logger = Logger.getLogger(DataFilterProcessorEtaChqBpm.class);
...
//	ApplicationContext context = new ClassPathXmlApplicationContext("ApplicationContex.xml");
	...
	public DataFilterProcessorEtaChqBpm() {
		super();
