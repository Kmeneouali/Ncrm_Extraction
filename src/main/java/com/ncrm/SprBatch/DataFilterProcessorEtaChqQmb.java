...
public class DataFilterProcessorEtaChqQmb implements ItemProcessor<BeanEtatsChq, BeanEtatsChq>  {
	
	
	private static final Logger logger = Logger.getLogger(DataFilterProcessorEtaChqQmb.class);
	String cdeBq= Propriete.getInsatance().get("BPM.cde.bq");
...
//	ApplicationContext context = new ClassPathXmlApplicationContext("ApplicationContex.xml");
	...
	public DataFilterProcessorEtaChqQmb() {
		super();
...
//		======================================================
		...
		libAno=metier.getAnomalie("BPM", "031", Mnemonique);
