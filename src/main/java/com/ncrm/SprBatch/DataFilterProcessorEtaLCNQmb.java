...
public class DataFilterProcessorEtaLCNQmb implements ItemProcessor<BeanEtatsLcn, BeanEtatsLcn>  {
	
	
	private static final Logger logger = Logger.getLogger(DataFilterProcessorEtaLCNQmb.class);
	String cdeBq= Propriete.getInsatance().get("QMB.cde.bq");
...
//	ApplicationContext context = new ClassPathXmlApplicationContext("ApplicationContex.xml");
	...
	public DataFilterProcessorEtaLCNQmb() {
...
//		======================================================	
		...
		libAno=metier.getAnomalie("QMB", "060", Mnemonique);
