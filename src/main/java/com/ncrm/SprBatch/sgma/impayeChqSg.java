...
@Entity
public class impayeChqSg implements Serializable{
	@Id
	private String REF;
	
	private String  PK_OBJ_IDT, RIO, RIOINI, REJET, ADR_RMT, ADR_TIR,
	
      
		
		AGE_RMT, AGE_RMT_LIB, CPT, CPTT, 
		DTEREG,  LOCT, MEM2, MNT,  NSER, SQCA, RIBT, 
		RSOC_RMT, RSOC_TIRE, ZBKT, ZBK_lib, NOMTIRE, CIN, RC,
		lieuEmission, MOTIF1, MOTIF2, MOTIF3,adresseTire, REJET_LIB,
		DTREJET, DTEINS, DTEPRE, DTEemission, DTETRT,DTE_SORT,ID_WEBCAPTUR,AGE_SCAN;

	
	@Transient
	private String  CDEBPR, CDEBPR_RMT, AGE,LOC,MODE_ESC,RIBR, RSOC_BEN,DTEMI;
	...
	public String getDTEREG() {
		return DTEREG;
	}

	public void setDTEREG(String dTEREG) {
		DTEREG = dTEREG;
	}
	...
	public String getMODE_ESC() {
		return MODE_ESC;
	}

	public void setMODE_ESC(String mODE_ESC) {
		MODE_ESC = mODE_ESC;
	}
	...
	public String getSQCA() {
		return SQCA;
	}

	public void setSQCA(String sQCA) {
		SQCA = sQCA;
	}
