...
public class impayeChq implements Serializable{
	private String REF, PK_OBJ_IDT, RIO, RIOINI, REJET, ADR_RMT, ADR_TIR,
			CDEBPR, CDEBPR_RMT, AGE, AGE_RMT, AGE_RMT_LIB, CPT, CPTT, DTEMI,
			DTEREG, LOC, LOCT, MEM2, MNT, MODE_ESC, NSER, SQCA, RIB, RIBR,
			RSOC_RMT, RSOC_TIRE, RSOC_BEN, ZBK, ZBK_lib, NOMTIRE, CIN, RC,
			lieuEmission, MOTIF1, MOTIF2, MOTIF3, adresseTire, REJET_LIB,
			DTREJET, DTEINS, DTEPRE, DTEemission, DTETRT,DTE_SORT;
