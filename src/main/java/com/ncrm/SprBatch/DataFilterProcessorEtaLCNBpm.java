...
public class DataFilterProcessorEtaLCNBpm implements ItemProcessor<BeanEtatsLcn, BeanEtatsLcn>  {
	
	
	private static final Logger logger = Logger.getLogger(DataFilterProcessorEtaLCNBpm.class);
...
//	ApplicationContext context = new ClassPathXmlApplicationContext("ApplicationContex.xml");
	...
	public DataFilterProcessorEtaLCNBpm() {
...
//		======================================================	
		...
		libAno=metier.getAnomalie("BPM", "060", Mnemonique);
