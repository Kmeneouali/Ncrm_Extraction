...
public class DataFilterProcessorEtaLCNBaa implements ItemProcessor<BeanEtatsLcn, BeanEtatsLcn>  {
	
	
	private static final Logger logger = Logger.getLogger(DataFilterProcessorEtaLCNBaa.class);
	String cdeBq= Propriete.getInsatance().get("BAA.cde.bq");
...
//	ApplicationContext context = new ClassPathXmlApplicationContext("ApplicationContex.xml");
	...
	public DataFilterProcessorEtaLCNBaa() {
...
//		======================================================	
		...
		libAno=metier.getAnomalie("BAA", "060", Mnemonique);
