...
@Entity
public class BeanImpLcn implements Serializable {
	@Id
	...
	DTEEC;
		...
		String 	NOMTIRE, CIN, RC,RIO,
			lieuEmission, Rejet,MOTIF1, MOTIF2, MOTIF3, adresseTire,ADR_RMT,RSOC_RMT,RSOC_TIRE, REJET_LIB,
			DTREJET, DTEINS, DTEemission;
