...
public class BaaRecordRemLCN implements Serializable {
    @Id
	String bmtr_pk_obj_idt;
	@Transient
    String dteJour,NumSeq,typeDoc,DiffMnt;
	
    public String getDiffMnt() {
		return DiffMnt;
	}
	public void setDiffMnt(String diffMnt) {
		DiffMnt = diffMnt;
	}
	String 
    bmtr_NSER,
	...
	@Transient
	List<BaaRecordLCN>recordsLcn=new ArrayList<BaaRecordLCN>();
	...
	public List<BaaRecordLCN> getRecordsLcn() {
		return recordsLcn;
	}
	public void setRecordsLcn(List<BaaRecordLCN> recordsLcn) {
