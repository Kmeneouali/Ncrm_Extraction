...
@Entity
public class BeanImpChqSG implements Serializable{
	@Id
	...
	DTE_TRT,
	DTE_SORT,REJET_LIB
	,ID_WEBCAPTUR,AGE_SCAN;
	
//	
	String RSOC_RMT,RSOC_TIRE,ADR_RMT,NOMTIRE,CIN,RC,LieuEmission,DTEemission,DTREJET,MOTIF1,MOTIF2,MOTIF3,ADR_TIR,DTEPRE,RIOINI,RIO,Rejet;
